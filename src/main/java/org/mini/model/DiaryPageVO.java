...
public class DiaryPageVO {
	...
	// CriteriaVO 포함
	private DiaryCriteriaVO cri;
	// board테이블의 전체건수를 저장
	private int total;

	// 매개변수가2개인 생성자 선언
	public DiaryPageVO(DiaryCriteriaVO cri, int total) {
		this.cri = cri;
		this.total = total;
		...
		// 13(realEnd)<20(endPage) -> realEnd적용
	...
	public DiaryCriteriaVO getCri() {
		return cri;
	}

	public void setCri(DiaryCriteriaVO cri) {
		this.cri = cri;
	}
